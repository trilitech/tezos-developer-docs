...
The Octez baking daemon stores relies in the Octez client's data directory to store persistent operational data, notably  consensus high-water marks and [random seed nonces](https://tezos.gitlab.io/active/randomness_generation.html).
