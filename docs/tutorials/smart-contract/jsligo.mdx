...
1. In the IDE, create a project from the empty template and select the JsLIGO syntax, as shown in this picture:
   ...
   <img src="/img/tutorials/ligo-online-ide-new-project.png" alt="Creating a project" style={{width: 500}} />
...
1. Test the contract by passing parameters and the storage value to the LIGO `dry-run` command:
   ...
   The Dry Run window looks like this:
      ...
      <img src="/img/tutorials/ligo-online-ide-dry-run-window.png" alt="The Dry Run window, showing the entrypoint to run, the parameter to pass, and the value of the storage" style={{width: 500}} />
...
1. Click **Estimate**.
   ...
   <img src="/img/tutorials/ligo-online-ide-deploy-estimate.png" alt="The estimate of the fees to deploy the contract" style={{width: 500}} />
