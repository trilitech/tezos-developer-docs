...
1. Compile the contract and run the tests by clicking the **Run Code** ![](/img/tutorials/smartpy-ide-run.png) button.
   ...
   ![The originated contract and the initial storage in the SmartPy IDE](/img/tutorials/smartpy-ide-origination.png)

   Then, the simulation runs the test cases and shows the results of each call to an entrypoint:

   ![The results of the entrypoint calls](/img/tutorials/smartpy-ide-test-entrypoints.png)
...
1. Under the origination step, click **Show Michelson**.
   ...
   ![The originated contract, with the **Show Michelson** button highlighted](/img/tutorials/smartpy-ide-origination-annotated.png)
...
1. In the new window, under "Node and Network," select the Ghostnet testnet and accept the default RPC node, as in this picture:
   ...
   ![Selecting the Ghostnet network and default RPC node](/img/tutorials/smartpy-ide-network.png)
...
1. When your wallet is connected, click **Validate**.
   ...
   ![The successful connection to your wallet on the origination page](/img/tutorials/smartpy-ide-connected-wallet.png)
...
1. Approve the transaction in your wallet app.
   ...
   ![Information about the originated contract](/img/tutorials/smartpy-ide-originated-contract.png)
