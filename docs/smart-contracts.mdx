...
<Figure src="/img/tezos_smart_contract_content.svg" number="1" caption="The contents of a Tezos smart contract" />
...
<Figure src="/img/invoke_smart_contract_wo_entrypoint.svg" number="2" caption="Call of a smart contract triggering its code and modifying its storage's state" />
