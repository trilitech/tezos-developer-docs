...
<Figure src="/img/invoke_smart_contract_wo_entrypointsdsdfdsfsdfsdfs.svg" caption="Figure 2: Call of a smart contract triggering its code and modifying its storage's state" />
