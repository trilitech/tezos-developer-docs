...
For example, Smart Rollups enable [Etherlink](https://www.etherlink.com/), which connects Tezos to Ethereum.
...
Smart Rollup nodes acheive consensus differently from layer 1 nodes.
