...
<LucidDiagram width="640px" height="480px" src="https://lucid.app/documents/embedded/3953825e-e5aa-43bb-bc43-701bb0ac3b73" id="stUZbULq.w1v" />
...
1. Triggering outbox messages: When the commitment can no longer be refuted, any client can trigger operations from the Smart Rollup.
...
At the end of a commitment period, the next commitment period starts and at the same time a refutation period starts for the commitment period that just ended.
