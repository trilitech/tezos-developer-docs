...
Smart Rollups allow you to run large amounts of processing that would be too slow or expensive to run on layer 1.
Thus they allow you to avoid some transaction fees and storage fees.
