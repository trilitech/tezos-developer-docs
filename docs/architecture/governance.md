...
This mechanism makes Tezos a self-amending blockchain and allows any user to propose changes to the [economic protocol](shell-and-protocol), which defines the possible blockchain operations and how they are processed.
