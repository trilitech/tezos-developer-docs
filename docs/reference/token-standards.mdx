...
<Figure src="/img/token-standards/standards.svg" alt="token-standard-implementation" caption="Figure 1: Illustration of 2 implementations of the same token standard" />
...
Note that FA2 is the successor to FA1.2 that only supports fungible tokens, it is still widely used in the Tezos ecosystem.


To learn more on how to implement FA2 tokens, please refer to the corresponding Tezos Improvements Proposal, [TZIP-12](https://tzip.tezosagora.org/proposal/tzip-12/).

<Figure src="/img/token-standards/tokens.svg" alt="fa2-token-standard" caption="Figure 2: Illustration of the multi-purpose aspect of the FA2 token standard." />
