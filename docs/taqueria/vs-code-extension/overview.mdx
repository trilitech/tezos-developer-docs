...
More details on how to install Taqueria VS Code Extension can be found [here](/taqueria/getting-started/installation.mdx)
...
{/* <img alt="VS Code extension intro" src={useBaseUrl('/img/taqueria/vs-code/taqueria-vs-code-intro.png')} /> */}
...
{/* <img alt="VS Code extension project sections" src={useBaseUrl('/img/taqueria/vs-code/taqueria-vs-code-project-sections.png')} /> */}

### Each section can be hidden and unhidden. More details can be found on the picture

{/* <img alt="VS Code extension hide and un-hide" src={useBaseUrl('/img/taqueria/vs-code/taqueria-vs-code-hide-unhide-sections.png')} /> */}
...
{/* <img alt="VS Code extension Plugins section" src={useBaseUrl('/img/taqueria/vs-code/taqueria-vs-code-plugins-section.png')} /> */}
...
{/* <img alt="VS Code extension Contracts section" src={useBaseUrl('/img/taqueria/vs-code/taqueria-vs-code-contracts-section.png')} /> */}
...
{/* <img alt="VS Code extension Artifacts section" src={useBaseUrl('/img/taqueria/vs-code/taqueria-vs-code-artifacts-section.png')} /> */}
...
{/* <img alt="VS Code extension select environment" src={useBaseUrl('/img/taqueria/vs-code/taqueria-vs-code-select-environment-option.png')} /> */}
...
{/* <img alt="VS Code extension Sandboxes section" src={useBaseUrl('/img/taqueria/vs-code/taqueria-vs-code-sandboxes-section.png')} /> */}
...
{/* <img alt="VS Code extension Environments section" src={useBaseUrl('/img/taqueria/vs-code/taqueria-vs-code-environments-section.png')} /> */}
...
{/* <img alt="VS Code extension Tests section" src={useBaseUrl('/img/taqueria/vs-code/taqueria-vs-code-tests-section.png')} /> */}