...
| [LIGO](/taqueria/plugins/plugin-ligo/)                     | `@taqueria/plugin-ligo`           | A compiler for the LIGO smart contract language (using LIGO v1 or later)        |
| [LIGO](/taqueria/plugins/plugin-ligo-legacy/)              | `@taqueria/plugin-ligo`           | A compiler for the LIGO smart contract language (using LIGO v0.73 and earlier)  |
| [SmartPy](/taqueria/plugins/plugin-smartpy/)               | `@taqueria/plugin-smartpy`        | A compiler for the SmartPy smart contract language (using v0.17 syntax)         |
| [SmartPy](/taqueria/plugins/plugin-smartpy/)               | `@taqueria/plugin-smartpy`        | A compiler for the SmartPy smart contract language (using v0.16 syntax)         |
| [Taquito](/taqueria/plugins/plugin-taquito/)               | `@taqueria/plugin-taquito`        | A front-end Tezos framework used to originate and interact with smart contracts |
