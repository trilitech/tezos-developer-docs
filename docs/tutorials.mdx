...
<GridContainer>
  ...
  <GridItem title="Build an NFT marketplace" icon="marketplace" href="#" description="Learn how to build a marketplace to buy and sell different kinds of tokens with LIGO smart contract templates" />
