...
<Figure src="/img/invoke_smart_contract.svg" number="3" caption="Call of a smart contract triggering its entrypoints, code, and modifying its storage's state" />
...
![tezos smart contract deploy invoke](/img/tezos_smart_contract_deploy_invoke.svg)
