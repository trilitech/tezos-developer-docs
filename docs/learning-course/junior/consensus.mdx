...
<QuizQuestion
  questionText="In Tezos, what determines a baker's likelihood of creating the next block?"
  q0="How many baking nodes they are running"
  q1="How much processing power their baking node has"
  q2="How much tez they stake"
  q3="How many people delegate tez to them"
