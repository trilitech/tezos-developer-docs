    ...
    links: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            href: '/basics/governance/history-of-amendments',
          },
          {
            title: 'Tezos Improvement Process',
            href: '/basics/governance/improvement-process-tzip',
          },
        ],
      },
      // {
      ...
      },
      {
        ...
        href: '/basics/protocol-and-shell',
      },
    ],
  },
  // {
    ...
    links: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            href: '/build/smart-contracts/avoiding-flaws',
          },
          {
            title: 'Common Examples',
            href: '/build/smart-contracts/common-examples',
          },
      ...
      },
      {
        ...
        children: [
          { title: 'Taquito', href: '/build/app-development/taquito' },
          ...
          },
          {
            ...
            href: '/build/app-development/wallets-and-beacon-sdk',
          },
          {
            title: 'Framework Best Practices',
            href: '/build/app-development/framework-best-practices',
          },
          {
            title: 'Test Networks',
            href: '/build/app-development/test-networks',
          },
          {
            title: 'Block Explorers',
            href: '/build/app-development/block-explorers',
            children: [
              {
                title: 'TzStats',
                href: '/build/app-development/block-explorers/tzstats-main-features',
              },
              {
                title: 'Inspect a Contract with TzStats',
                href: '/build/app-development/block-explorers/tzstats-smart-contract',
              },
            ],
          },
          { title: 'Oracles', href: '/build/app-development/oracles' },
        ],
      },
      {
  ...
  },
  {
    ...
    links: [
      { title: 'Smart Rollups', href: '/build/advanced/smart-rollups' },
      {
        ...
        href: '/build/advanced/formal-verification',
        children: [
          {
            title: 'On Tezos',
            href: '/build/advanced/formal-verification/on-tezos',
          },
          {
            title: 'Modelling for Smart Contracts',
            href: '/build/advanced/formal-verification/modelling-theorem',
          },
          { title: 'Coq', href: '/build/advanced/formal-verification/coq' },
          {
            title: 'Mi-Cho-Coq',
            href: '/build/advanced/formal-verification/michocoq',
          },
          {
            title: 'GADT Coq',
            href: '/build/advanced/formal-verification/gadt-coq',
          },
        ],
      },
    ],
        ...
        children: [
          {
            ...
            href: '/participate/get-started-with-octez/cli-rpc',
          },
          {
            title: 'Installation and Setup',
            href: '/participate/get-started-with-octez/installation-and-setup',
          },
          {
            title: 'Node Upgrade',
            href: '/participate/get-started-with-octez/upgrade',
          },
          {
            title: 'Monitor a Node',
            href: '/participate/get-started-with-octez/monitor-a-node',
          },
          {
            title: 'Sandbox Mode',
            href: '/participate/get-started-with-octez/run-a-sandbox',
          },
          {
            title: 'Best Practices',
            href: '/participate/get-started-with-octez/best-practices',
          },
        ],
      },
      // {
      ...
      // },
      {
        ...
        children: [
          ...
          },
          {
            ...
            href: '/participate/baking/baker-selection',
          },
        ],
      },
    ],
  ...
  let section = navigation.find((section) => {
    return section.links.find((link) => {
      if (link.href === router.pathname) {
        ...
        let foundChild = link.children.find(
          (childLink) => childLink.href === router.pathname
        )
        if (foundChild) {
        ...
        <div class="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
          <div class="w-30 flex flex-wrap gap-y-2 md:mb-2 md:flex md:w-1/2 lg:flex-wrap 2xl:flex-nowrap">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="mx-1 mb-3 hover:opacity-60 xl:mx-3 "
            >
              <svg
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="tooltip-space mx-1 mb-3 xl:mx-3 "
            >
              <svg
            ...
            <a
              href="https://github.com/tezos/tezos"
              target="_blank"
              rel="noopener noreferrer"
              class="mx-1 mb-3 hover:opacity-60 xl:mx-3 "
            >
            ...
            <a
              href="https://forum.tezosagora.org/"
              target="_blank"
              rel="noopener noreferrer"
              class="mx-1 mb-3 hover:opacity-60 xl:mx-3 "
            >
          ...
          <div class="mb-2 md:order-1 md:mt-0">
            <p class="mb-2 text-left text-xs leading-5 text-white hover:text-gray-300 lg:text-center">
              {' '}
              <a href="/">Return to Tezos.com</a>{' '}
            </p>
            <p class="pb-3 text-left text-xs leading-5 text-white hover:text-gray-300 lg:text-center">
              {' '}
              <a href="https://tezos.com/privacy-notice">Privacy Notice</a>
            </p>
          </div>
        </div>
      </footer>
