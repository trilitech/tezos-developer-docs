...
const navigation = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: 'Build an NFT Marketplace', href: '/nft/build-an-nft-marketplace' },
      ...
      <footer class="bg-slate-900 dark:border-t-2">
        <div class="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
          ...
          <div class="mb-2 md:order-1 md:mt-0">
            <p class="text-left lg:text-center text-xs leading-5 text-white hover:text-gray-300 mb-2"> <a href='/'>Return to Tezos.com</a> </p>
            <p class="pb-3 text-left lg:text-center text-xs leading-5 text-white hover:text-gray-300"> <a href="https://tezos.com/privacy-notice">Privacy Notice</a></p>
          </div>
