...
//         <h2 className="mt-4 font-display font-semibold text-base text-slate-900 dark:text-white">
//           <Link href={href}>
    ...
    <div className="group relative border border-slate-200 dark:border-slate-800">
      ...
      <div className="relative overflow-hidden rounded-xl p-6">
        ...
        <h2 className="mt-4 font-display font-semibold text-base text-slate-900 dark:text-white">
          {badgeText ? (
            <>
              <div className={`mb-0.5 flow-root w-fit items-center rounded-full bg-${badgeColor}-50 px-1 py-0.5 text-xxs font-medium text-${badgeColor}-700 ring-1 ring-inset ring-${badgeColor}-600/10 dark:bg-transparent dark:text-white dark:ring-white`}>
                {badgeText}
              </div>
              {title}
            </>
