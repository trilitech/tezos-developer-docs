...
Some of the most basic information available on blockchain explorers includeing (but are not limited to):
...
* app developers who need debugging tools and greater visibility into the current and past states of their contracts running on internal testnets and the mainnet.
